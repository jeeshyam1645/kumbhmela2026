        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-4">
              {t("Auspicious Bathing Dates 2026", "शुभ स्नान तिथियां 2026")}
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              {t(
                "These are the most important dates for the holy dip during Magh Mela 2026. Plan your visit around these dates for maximum spiritual benefit.",
                "माघ मेला 2026 के दौरान पवित्र स्नान के लिए ये सबसे महत्वपूर्ण तिथियां हैं। अधिकतम आध्यात्मिक लाभ के लिए इन तिथियों के आसपास अपनी यात्रा की योजना बनाएं।"
              )}
            </p>
          </div>
